 ...
 * @domain magicfolder
 * @layer api
 * @responsibility Presigned GET URL for canonical preview (preview.pdf when generated)
 */
...
import { canonicalPreviewKey } from "@/lib/server/r2/magicfolder-keys"
...
export async function GET(
  ...
  try {
    ...
    const key = canonicalPreviewKey(tenantId, id, versionId)
